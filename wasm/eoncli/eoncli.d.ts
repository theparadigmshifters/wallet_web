...
export function calculate_zk_proof_inputs(account_json: string, secret: string, tx_json: string): string;
export function encode_zk_wptx(vk_hex: string, proof_hex: string, tx_json: string): string;
/**
